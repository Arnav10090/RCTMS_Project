    ...
    <div className="w-full h-full p-4 bg-white flex items-center justify-center overflow-auto">
      <svg width="1100" height="800" viewBox="0 0 1100 800" preserveAspectRatio="xMidYMid meet" className="block h-auto max-w-full">
        ...
        <g transform="translate(0, 120)">
          ...
          <line x1="800" y1="230" x2="800" y2="-85" stroke="#000" strokeWidth="2" />

          {/* Heat exchanger circles - 6 circles with proper sizing */}
          {/* Top circle - largest */}
          <circle cx="935" cy="-90" r="22" fill="white" stroke="#000" strokeWidth="2" />

          {/* Second circle */}
          <circle cx="935" cy="-46" r="18" fill="white" stroke="#000" strokeWidth="2" />

          {/* Third circle - smallest */}
          <circle cx="935" cy="-13" r="13" fill="white" stroke="#000" strokeWidth="2" />

          {/* Fourth circle - smallest (on dashed line) */}
          <circle cx="935" cy="16" r="13" fill="white" stroke="#000" strokeWidth="2" />

          {/* Fifth circle */}
          <circle cx="935" cy="50" r="18" fill="white" stroke="#000" strokeWidth="2" />

          {/* Bottom circle - largest */}
          <circle cx="935" cy="93" r="22" fill="white" stroke="#000" strokeWidth="2" />

          {/* Bottom circle - largest */}
          <image href="/svgs/trapezoid.svg" x="860" y="85" width="150" height="100" />

          {/* Left inlet lines with dots and arrows */}
          <line x1="800" y1="-85" x2="875" y2="-85" stroke="#000" strokeWidth="2" />
          <image href="/svgs/filled_circle.svg" x="900" y="-78" width="6" height="6" />
          <line x1="875" y1="-85" x2="903" y2="-75" stroke="#000" strokeWidth="2" />
          <image href="/svgs/4pm_arrow.svg" x="900" y="-78" width="20" height="20" />

          <line x1="800" y1="-57" x2="875" y2="-57" stroke="#000" strokeWidth="2" />
          <image href="/svgs/filled_circle.svg" x="897" y="-38" width="6" height="6" />
          <line x1="874.5" y1="-57" x2="900" y2="-35" stroke="#000" strokeWidth="2" />
          <image href="/svgs/4pm_arrow.svg" x="894" y="-40" width="20" height="20" />

          <line x1="800" y1="-27" x2="865" y2="-27" stroke="#000" strokeWidth="2" />
          <image href="/svgs/filled_circle.svg" x="891" y="-15" width="6" height="6" />
          <line x1="865" y1="-27" x2="895" y2="-12" stroke="#000" strokeWidth="2" />
          ...
          <line x1="800" y1="35" x2="865" y2="35" stroke="#000" strokeWidth="2" />
          <line x1="865" y1="35" x2="895" y2="17" stroke="#000" strokeWidth="2" />
          <image href="/svgs/2pm_arrow.svg" x="893" y="5.5" width="20" height="20" />

          <line x1="800" y1="63" x2="870" y2="63" stroke="#000" strokeWidth="2" />
          <line x1="870" y1="63" x2="900" y2="43" stroke="#000" strokeWidth="2" />
          <image href="/svgs/2pm_arrow.svg" x="898" y="31" width="20" height="20" />

          <line x1="800" y1="91" x2="875" y2="91" stroke="#000" strokeWidth="2" />
          <line x1="875" y1="91" x2="905" y2="80" stroke="#000" strokeWidth="2" />
          ...
          <line x1="935" y1="125" x2="935" y2="280" stroke="#000" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
